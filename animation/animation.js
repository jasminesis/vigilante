...
(function () {
    ...
    const SPRITE_WIDTH = 263;
    const SPRITE_HEIGHT = 210;
    ...
    render = function () {
        ...
        buffer.drawImage(sprite_sheet.image, player.animation.frame * SPRITE_WIDTH, 0, SPRITE_HEIGHT, SPRITE_HEIGHT, Math.floor(player.x), Math.floor(player.y), SPRITE_WIDTH, SPRITE_HEIGHT);
    ...
    sprite_sheet.image.src = "animation.jpg"; // Start loading the image.
